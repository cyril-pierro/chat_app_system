...
This service is responsible the authentication and authorization for users of the chat application. It also supports user operations and account operations
