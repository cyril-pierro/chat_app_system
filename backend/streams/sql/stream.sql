...
create stream create_account_stream with (kafka_topic='created_account', value_format='json') as select after->user_id as user_id, after->profile_pic as profile_pic, after->is_active as is_active from account_stream where op = 'u';
...
create stream elastic_users_stream with (kafka_topic='elasticsearch_users', value_format='json') as
